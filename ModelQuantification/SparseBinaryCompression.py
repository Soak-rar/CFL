...
def train(global_model_dict, datasetLoader, worker_id,res_model_dict ,device, args: Args.Arguments, is_global_res = False, use_res = True):

    if res_model_dict is not None and use_res and is_global_res:
